...
class SaladCheckbox extends React.Component {
    ...
    toggle() {
        ...
        /* 
        TODO: validerar om det finns en sådan funktion angiven 
            Går igenom properties i rest och anropar
        */
    ...
    render() {
        return ( <
            ...
            htmlFor = "ingredientCheckbox" > { `${this.ingredient} (+${this.cost}kr)` /* Skriver ut namn och pris för en angiven ingrediens */ } <
            /label> <
            /div>
        );
    }
